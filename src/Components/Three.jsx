...
const Three = () => {
  ...
  return (
    <div className='bg-black'>
        <div className='relative bg-[url("src/assets/page3.jpeg")] mobile:w-full mobile:h-screen laptop:bg-cover bg-center mobile:-mt-24 laptop:mt-48 flex items-end justify-start laptop:px-48 mobile:bg-[length:125%] mobile:bg-no-repeat mobile:px-6 '>
        ...
        <div className='w-full h-full flex items-center justify-center laptop:mt-20 mobile:mt-0 mobile:px-5'>
            <img className='laptop:w-[75%] rounded-md' src="src/assets/Interior.jpg" alt="" />   
        </div>
        ...
        <div className='bg-[url("src/assets/roadster-glass-desktop.jpg")] mobile:w-full mobile:h-screen laptop:bg-cover bg-center mobile:-mt-60 laptop:mt-48 flex items-end justify-start laptop:px-48 mobile:bg-[length:125%] mobile:bg-no-repeat mobile:px-6 '>
